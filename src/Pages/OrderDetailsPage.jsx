...
const OrderDetailsPage = () => {
  ...
  return (
    <div className="flex justify-center">
      ...
      <div className="flex flex-col w-full sm:w-[80%] pt-16 min-h-[70vh] mb-10 ">
        <div  className="flex flex-col gap-3">
        {orders? orders.map((order)=>(
          <div className="flex items-center px-5 sm:px-[10%] gap-5 sm:gap-[20%] font-lightbold bg-grey py-8"
          key={order._id}>
